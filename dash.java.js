...
function showPopup() {
    ...
    popup.innerHTML = `
        <div class="k7m8n9">
            <p>You have not purchased. <a href="https://t.me/landingforsmmpanel" target="_blank">Click here</a> to purchase.</p>
            <button class="b1c2d3" onclick="window.open('https://t.me/landingforsmmpanel', '_blank')">Purchase Now</button>
        </div>
    `;
